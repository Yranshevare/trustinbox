  ...
  return (
    ...
    >
      <Portal.Root>
        <div
          className={cn(
            'pointer-events-none fixed inset-0 z-50 mx-auto flex w-full max-w-lg flex-col items-center justify-center data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95',
            className,
          )}
          {...props}
        >
...
export const DialogStackContent = ({
  ...
  return (
    ...
    <div
      onClick={handleClick}
      className={cn(
        'h-auto w-full rounded-lg border bg-background p-4 shadow-lg transition',
