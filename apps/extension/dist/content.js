...
function extractEmailContent() {
    ...
    const senderElement = document.querySelector(".gD") || document.querySelector("[data-email]");
...
async function analyzeCurrentEmail() {
    ...
    try {
        ...
        const response = await new Promise((resolve, reject) => {
            chrome.runtime.sendMessage({ type: "ANALYZE_EMAIL", emailData }, (response) => {
...
function toggleSidebar() {
    const sidebar = document.getElementById("trustinbox-sidebar") || createSidebar();
    if (!sidebarOpen) {
...
function init() {
    const toolbar = document.querySelector(".aJV") ||
