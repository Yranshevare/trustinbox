...
export default function SignUpPage() {
  ...
  async function handleManualSignUp(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
  ...
  return (
    <div className="mx-auto max-w-sm px-6 py-20 sm:px-0 md:py-28">
      <div className="grid gap-1 text-center">
        <h1 className="text-lg font-bold sm:text-xl">Glad to have you!</h1>
      ...
      <div className="mt-10 grid gap-10">
        ...
        <form onSubmit={handleManualSignUp} className="grid gap-2">
